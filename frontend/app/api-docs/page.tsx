          ...
          <Card>
            <CardBody>
              <dl className="grid grid-cols-[120px_1fr] gap-y-2 text-sm">
                ...
                <dd>22 consolidated tools available at <a href="https://mcp.depscope.dev/mcp" className="text-[var(--accent)] hover:underline">mcp.depscope.dev/mcp</a> (remote, zero install)</dd>
              </dl>
            </CardBody>
          </Card>
        </Section>
